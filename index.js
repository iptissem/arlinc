...
const server = http.createServer(async (req, res) => {
    ...
    if (req.url === '/') {
        ...
        if (cartItems && cartItems.length > 0) {
            ...
            // Répondre avec la page HTML contenant le tableau
            res.end(`
                <!DOCTYPE html>
                <html lang="fr">
                <head>
            ...
            res.end('<h1>Aucun article trouvé dans la collection Cart.</h1>');
        }
    } else {
        res.statusCode = 404;
